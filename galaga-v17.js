/**
 * GALAGA — Namco / Midway 1981 style recreation (Build V17)
 * V17: arcade PCB fidelity — multi-frame Namco pixel art (fighter/bee/
 * butterfly/Boss green→blue), explosion cycles, tractor trapezoid frames,
 * layered starfield, vivid Namco RGB palette. WSG wavetables retuned to
 * match public Namco 32-sample 4-bit character (hand-authored constants;
 * no ROM/PROM/PCM committed). Keeps capture/dual-fighter FSM.
...
(() => {
  ...
  // Boss damaged — classic blue after first hit (same bird silhouette)
  const SPR_BOSS_HURT = [
    [
      "C.BB.......BB.C",
      "CBBBb.....bBBBC",
  ...
  hud();
  if ($high) $high.textContent = pad(high);
  showOV("GALAGA", "INSERT COIN", "BUILD V17 — PRESS SPACE OR TAP");
})();
