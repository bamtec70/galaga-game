/**
 * GALAGA — Namco / Midway 1981 style recreation (Build V19)
 * V19: rounder arcade sprites + denser pixel detail (fighter/bee/butterfly/
 * Boss green→blue/captured/explosions) toward PCB look at readable Dig Dug
 * scale — still not 5200-chunky. WSG-only audio retuned further by ear from
 * private ROM analysis (NO ROM samples, PROM dumps, WAV, or VGM shipped).
 * Capture/dual-fighter FSM unchanged.
 */
(() => {
  "use strict";
